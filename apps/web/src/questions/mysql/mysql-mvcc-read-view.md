...
next:
  text: "如何保证缓存和数据库一致性？"
  link: "/questions/redis/redis-cache-consistency.html"
---
...
- [小林 MySQL MVCC](https://xiaolincoding.com/mysql/transaction/mvcc.html) · 用于 ReadView 可见性解释。
