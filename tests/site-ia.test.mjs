...
test("core content is migrated into java/database/blog paths", () => {
  for (const relativePath of [
    ...
    "src/java/collection/README.md",
    "src/java/collection/java-collection-arraylist-linkedlist.md",
    "src/java/collection/java-collection-hashmap-structure.md",
    "src/java/collection/java-collection-hashmap-thread-safety.md",
    "src/java/collection/java-collection-concurrenthashmap.md",
    "src/java/collection/java-collection-linkedhashmap-lru.md",
    "src/java/collection/java-collection-hashset.md",
    "src/java/collection/java-collection-copyonwritearraylist.md",
    "src/java/collection/java-collection-queue-scenarios.md",
    "src/java/jvm/README.md",
    "src/java/jvm/jvm-memory-areas.md",
    "src/java/jvm/jvm-object-lifecycle.md",
    "src/java/jvm/jvm-class-loading.md",
    "src/java/jvm/jvm-classloader.md",
    "src/java/jvm/jvm-object-recycling.md",
    "src/java/jvm/jvm-gc-collectors.md",
    "src/java/jvm/jvm-g1-vs-cms.md",
    "src/java/jvm/jvm-g1-zgc-shenandoah-scenarios.md",
    "src/java/jvm/jvm-oom-troubleshooting.md",
    "src/java/jvm/jvm-full-gc-troubleshooting.md",
    "src/java/jvm/jvm-parameters-tuning.md",
    "src/java/new-features/README.md",
    "src/java/new-features/java-new-features-stream-optional.md",
    "src/java/new-features/java-new-features-java17-lts.md",
    "src/java/new-features/java-new-features-java21-virtual-threads.md",
    "src/java/new-features/java-new-features-modern-syntax.md",
    "src/cs-basics/operating-system/README.md",
    "src/cs-basics/operating-system/os-process-thread.md",
    "src/cs-basics/operating-system/os-context-switch.md",
    "src/cs-basics/operating-system/os-thread-count-limit.md",
    "src/cs-basics/operating-system/os-ipc.md",
    "src/cs-basics/operating-system/os-deadlock.md",
    "src/cs-basics/operating-system/os-virtual-memory.md",
    "src/cs-basics/operating-system/os-malloc-physical-memory.md",
    "src/cs-basics/operating-system/os-page-cache.md",
    "src/cs-basics/operating-system/os-io-multiplexing.md",
    "src/cs-basics/operating-system/os-zero-copy.md",
    "src/cs-basics/operating-system/os-reactor-netty.md",
    "src/cs-basics/network/README.md",
    "src/cs-basics/network/network-tcp-ip-model.md",
    "src/cs-basics/network/network-url-process.md",
    "src/cs-basics/network/network-tcp-three-way-handshake.md",
    "src/cs-basics/network/network-tcp-four-way-wave-time-wait.md",
    "src/cs-basics/network/network-tcp-reliability.md",
    "src/cs-basics/network/network-tcp-flow-congestion-control.md",
    "src/cs-basics/network/network-tcp-queue-overflow.md",
    "src/cs-basics/network/network-server-no-accept.md",
    "src/cs-basics/network/network-http-versions.md",
    "src/cs-basics/network/network-https-rsa-ecdhe.md",
    "src/cs-basics/network/network-http-keepalive-tcp-keepalive.md",
    "src/cs-basics/network/network-tcpdump-handshake-retransmission.md",
    ...
    "src/database/mysql/mysql-update-execution.md",
    "src/database/mysql/mysql-crash-recovery-logs.md",
    "src/database/mysql/mysql-flush-policy.md",
    "src/database/mysql/mysql-next-key-lock-range.md",
    "src/database/mysql/mysql-slow-query-troubleshooting.md",
    "src/database/mysql/mysql-deadlock-log-analysis.md",
    "src/database/mysql/mysql-replication-delay-troubleshooting.md",
    "src/database/mysql/mysql-online-ddl.md",
    ...
    "src/database/redis/redis-internal-data-structures.md",
    "src/database/redis/redis-zset-skiplist.md",
    "src/database/redis/redis-single-thread-performance.md",
    ...
    "src/database/redis/redis-persistence-latency.md",
    "src/database/redis/redis-rdb-fork-risk.md",
    "src/database/redis/redis-aof-rewrite-stall.md",
    "src/database/redis/redis-replication-internals.md",
    "src/database/redis/redis-sentinel-failover.md",
    ...
    "src/database/redis/redis-bigkey-persistence-replication-delete.md",
    ...
    "src/system-design/framework/spring-ioc-container-startup.md",
    "src/system-design/framework/spring-bean-lifecycle-extension-points.md",
    "src/system-design/framework/spring-circular-dependency-resolution.md",
    "src/system-design/framework/spring-aop-proxy-weaving.md",
    "src/system-design/framework/spring-transaction-failure-cases.md",
    "src/system-design/framework/spring-mvc-request-processing.md",
    "src/system-design/framework/spring-boot-auto-configuration-principles.md",
    "src/system-design/framework/mybatis-cache-pitfalls.md",
    "src/system-design/framework/mybatis-plugin-pagination-mechanism.md",
    "src/system-design/security/README.md",
    "src/system-design/security/security-authentication-authorization.md",
    "src/system-design/security/security-session-cookie-token-jwt.md",
    "src/system-design/security/security-jwt-vs-session.md",
    "src/system-design/security/security-sso-flow.md",
    "src/system-design/security/security-rbac-design.md",
    "src/system-design/security/security-password-reset.md",
    "src/system-design/security/security-crypto-algorithms.md",
    "src/system-design/security/security-data-masking-encryption.md",
    "src/distributed-system/distributed-cap-base.md",
    ...
    "src/high-performance/high-performance-bottleneck-analysis.md",
    "src/high-performance/high-performance-sql-optimization-chain.md",
    "src/high-performance/high-performance-read-write-splitting-consistency.md",
    "src/high-performance/high-performance-sharding-tradeoffs.md",
    "src/high-performance/high-performance-message-queue-role.md",
    "src/high-performance/high-performance-message-reliability.md",
    "src/high-performance/high-performance-message-idempotency.md",
    "src/high-performance/high-performance-message-backlog.md",
    "src/high-performance/high-performance-mq-selection.md",
    "src/high-availability/README.md",
    "src/high-availability/high-availability-sla-rto-rpo.md",
    "src/high-availability/high-availability-rate-limiting.md",
    "src/high-availability/high-availability-resilience-composition.md",
    "src/high-availability/high-availability-retry-storm.md",
    "src/high-availability/high-availability-idempotency-design.md",
    "src/high-availability/high-availability-idempotency-cases.md",
    "src/high-availability/high-availability-disaster-recovery.md",
    "src/high-availability/high-availability-performance-testing.md",
    "src/ai-coding/README.md",
    "src/ai-coding/ai-coding-code-review.md",
    "src/ai-coding/ai-coding-project-context.md",
    "src/ai-coding/ai-coding-technical-writing.md",
    "src/ai-coding/ai-coding-acceptance.md",
    "src/open-source-project/README.md",
    "src/open-source-project/source-reading-spring-entry.md",
    "src/open-source-project/source-reading-mybatis-entry.md",
    "src/open-source-project/source-reading-netty-entry.md",
    "src/open-source-project/source-reading-project-expression.md",
    "src/books/README.md",
    "src/books/books-java-jvm-concurrency.md",
    "src/books/books-database-middleware.md",
    "src/books/books-cs-system-design.md",
